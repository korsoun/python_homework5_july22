# Создать программу для игры в крестики-нолики.
...
while not iswinner and len(remain_steps) > 0:
    print_field(field)
    choise = None
    ...
    if field[2] == field[5] == field[8] == (player1_mark or player2_mark) or field[1] == field[4] == field[7] == (player1_mark or player2_mark) or field[0] == field[3] == field[6] == (player1_mark or player2_mark) or \
        field[6] == field[7] == field[8] == (player1_mark or player2_mark) or field[3] == field[4] == field[5] == (player1_mark or player2_mark) or field[0] == field[1] == field[2] == (player1_mark or player2_mark) or \
         field[6] == field[4] == field[2] == (player1_mark or player2_mark) or field[0] == field[4] == field[8] == (player1_mark or player2_mark):
          iswinner = 1
